...
public class TanFunctionGui {
    ...
    private static void placeComponents(JPanel panel) {
        ...
        setAccessibility(userLabel, "Angle Input Label", "Label prompting the user to enter an angle in radians");

        JTextField angleText = new JTextField(10);
        constraints.gridx = 1;
        panel.add(angleText, constraints);
        setAccessibility(angleText, "Angle Input Field", "Input field for entering an angle in radians");
        ...
        setAccessibility(calculateButton, "Calculate Button", "Button to calculate the tangent of the entered angle");
        ...
        setAccessibility(resultArea, "Result Area", "Text area displaying the result or error messages");
